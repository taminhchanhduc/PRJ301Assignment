<%-- 
    Document   : cart
    Created on : Jul 18, 2022, 3:26:07 PM
    Author     : Duc
--%>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <div class="input-group mb-4 border rounded-pill p-2">
                                        <input type="text" placeholder="Discount Voucher" aria-describedby="button-addon3" class="form-control border-0">
                                        <div class="input-group-append border-0">
                                            <button id="button-addon3" type="button" class="btn btn-dark px-4 rounded-pill"><i class="fa fa-gift mr-2"></i>Apply</button>
                                        </div>
                                        <div>
                                            <input type="text" placeholder="Your Address" aria-describedby="button-addon3" class="form-control border-0">
                                        </div>
                                        <div>
                                            <input type="text" placeholder="Your Phone Number" aria-describedby="button-addon3" class="form-control border-0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total Amount</strong><strong>100 $</strong></li>
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Payments</strong><strong>Cash On Delivery</strong></li>
                                    </ul><a href="buy" class="btn btn-dark rounded-pill py-2 btn-block">Purchase Confirmation</a>
                                </div>
                            </div>
                        </div>
