<%-- 
    Document   : index
    Created on : Jun 17, 2022, 10:31:28 PM
    Author     : khangtl
--%>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Fast delivery 4-5 hours after ordering, For overseas orders, it may take up to 1 to 2 weeks to receive the goods.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Free shipping for orders within the city, Ho Chi Minh City and Hanoi. For overseas orders, the shipping fee will be calculated according to our local shipping unit.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                We guarantee the quality of products 1 to 1 exchange when detecting damage due to transportation. The product image is the same as when received. Products are 100% handmade.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-7 col-md-6 px-0">
          <div class="map_container">
            <div class="map-responsive">
              <iframe src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=140A Tân Hòa Đông&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="600" height="300" frameborder="0" style="border:0; width: 100%; height:100%" allowfullscreen></iframe>
            </div>
          </div>
        </div>
